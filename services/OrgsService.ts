...
import type { org_custom_property } from '../models/org_custom_property';
...
export class OrgsService {
     ...
     * @param org The organization name. The name is not case sensitive.
     * @returns org_custom_property Response
     * @throws ApiError
     */
    public static orgsGetAllCustomProperties(
        org: string,
    ): CancelablePromise<Array<org_custom_property>> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static orgsCreateOrUpdateCustomProperties(
        org: string,
        requestBody: {
            /**
             * The array of custom properties to create or update.
             */
            properties: Array<org_custom_property>;
        },
    ): CancelablePromise<Array<org_custom_property>> {
        return __request(OpenAPI, {
            method: 'PATCH',
     ...
     * @throws ApiError
     */
    public static orgsGetCustomProperty(
        org: string,
        customPropertyName: string,
    ): CancelablePromise<org_custom_property> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static orgsCreateOrUpdateCustomProperty(
        org: string,
        customPropertyName: string,
        requestBody: {
            /**
     ...
     * @throws ApiError
     */
    public static orgsRemoveCustomProperty(
        org: string,
        customPropertyName: string,
    ): CancelablePromise<void> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static orgsListCustomPropertiesValuesForRepos(
        org: string,
        perPage: number = 30,
        page: number = 1,
     ...
     * @throws ApiError
     */
    public static orgsCreateOrUpdateCustomPropertiesValuesForRepos(
        org: string,
        requestBody: {
            /**
