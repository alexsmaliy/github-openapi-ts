...
import type { codespaces_permissions_check_for_devcontainer } from '../models/codespaces_permissions_check_for_devcontainer';
...
export class CodespacesService {
     ...
     * @returns codespaces_permissions_check_for_devcontainer Response when the permission check is successful
     * @throws ApiError
     */
    public static codespacesCheckPermissionsForDevcontainer(
        owner: string,
        repo: string,
        ref: string,
        devcontainerPath: string,
    ): CancelablePromise<codespaces_permissions_check_for_devcontainer> {
        return __request(OpenAPI, {
            method: 'GET',
